...
def enumera_veiculo_atual_e_seu_semelhante_com_o_mesmo_numero(img_atual, img_proximo, coordenada_atual, coordenada_semelhante, numero_veiculo):
...
def processar_quadros(model, quadros, pasta_quadros, pasta_run):
    ...
    for i in range(len(quadros) - 1):
        ...
        for histograma_atual, coordenada_atual, id_atual  in histogramas_atuais:
            ...
            enumera_veiculo_atual_e_seu_semelhante_com_o_mesmo_numero(img_atual, img_proximo, coordenada_atual, coordenada_semelhante, id_proximo)

            histogramas_proximos = histogramas_atuais
