...
def main():
    ...
    pasta_quadros = 'C:/Users/rodri/Desktop/TCC/imagens_trafego_intenso'
    quadros = sorted([f for f in os.listdir(pasta_quadros) if f.endswith('.jpg')])
    model = YOLO('yolov8m.pt')
    pasta_run = criar_pasta_run()

    processar_quadros(model, quadros, pasta_quadros, pasta_run)
